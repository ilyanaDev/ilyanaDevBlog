...
![](creating-gatsby-blog-netlify.png)

Gatsby and Netlify together produce a powerful website building and hosting duo.
...
![Kaldi Starter Site](gatsby-starter-kaldi.png "Kaldi Starter Site")
...
![Open Site in VS Code](open-in-vscode.png "Open Site in VS Code")
...
![Edit Index Page](edit-index-page.png "Edit Index Page")
...
![Deleting Page Elements](delete-page-element.png "Deleting Page ELements")
...
![Deleting a Page](delete-page.png "Deleting a Page")
...
![Changing Header Colors](header-color.png "Changing Header Colors")
...
![Frontmatter](frontmatter-blog.png "Frontmatter for Blog Posts")
