...
![](mythical-manmonth.png)

The Mythical Man-Month by Fred Brooks is considered somewhat of a classic in the world of books about software.
...
* 3 possible relationships between successful producer-director team:
  * producer and director = same person
    * only workable on tiny teams (less than 6 people)
