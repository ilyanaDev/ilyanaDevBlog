...
![](fixing-network-cables.png)

Sometimes you need a network cable of a certain length, or need to replace the end of an old cable. Making your own cable can also be far cheaper than buying one. Having the know-how (and tools) to be able to do so can be quite handy in such situations.
...
![End of Network Cable](network-cable-end.png "Start with interior of cable exposed")
...
![Stripped Network Cable](network-cable-stripped.png "Strip the end of the cable about one inch")
...
![Separator Cut Off](network-cable-separator-cut-off.png "Cut off the separator as close as possible to the bottom of the stripped section")
...
![Interior Wires Arranged](network-cable-wires-arranged.png "Arrange the wires in the proper order")
...
![Orientation of Connector](network-cable-connector-diagram.png "This diagram shows how to orient your wires in your connector.")
