...
I use Markdown to write my blog posts, and I've found it very easy to use in VS Code.
...
![VS Code Extensions Marketplace](vscode-extensions-marketplace.png "VS Code Extensions Marketplace")

Once you find the extensions you'd like to use, hit the **Install** button to install them.

![Markdown All in One Installation](markdown-allinone-extension.png "Markdown All in One Installation")
...
![VS Code Plaintext](vscode-plaintext.png "VS Code Plaintext")

![VS Code Markdown](vscode-selectmarkdown.png "VS Code Markdown")

![VS Code Markdown](vscode-markdown.png "VS Code Markdown")
...
![VS Code Extension Settings](vscode-extension-settings.png "VS Code Extension Settings")

![VS Code Extension Settings](vscode-extension-autopreview.png "VS Code Extension Settings")
...
![VS Code Markdown Preview](vscode-markdown-preview.png "VS Code Markdown Preview")
