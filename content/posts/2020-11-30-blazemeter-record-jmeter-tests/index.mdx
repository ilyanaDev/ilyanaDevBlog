...
JMeter is a powerful performance testing tool, but BlazeMeter can help you make the most of the time you spend with JMeter.
...
![BlazeMeter Test Recording](blazemeter-record.png "Steps to record a BlazeMeter Test")
...
![BlazeMeter Config Elements](blazemeter-config-elements.png "BlazeMeter adds all these config elements for me")
...
![BlazeMeter Config Elements](blazemeter-token-set.png "BlazeMeter adds all these config elements for me")
...
![Extracting the Token](blazemeter-token-extract.png "Extracting the token")
...
![Using the Token](blazemeter-token-use.png "Using the token")
...
![Devtools Style](devtools-style.png "Devtools is fun")
