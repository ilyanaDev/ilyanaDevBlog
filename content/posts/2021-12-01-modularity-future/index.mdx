...
You might not normally see much in common between aerospace engineering and computer science. And in a lot of cases, you'd be right. But both these industries are and have been trending towards one common goal - modularity.
...
![Hubble Space Telescope](hubble_service.jpg)
...
![International Space Station](iss.png)
