...
![](connecting-github.png)

As a beginner, even simple tasks like creating a new GitHub repository to access from your desktop can seem overly complex.

This seemingly simple task can get somewhat complicated if you don't know what you're doing. I've certainly had trouble with this. Here is the easiest way I've found to do this:
...
![New GitHub Repo](github-repositories-new.png "New GitHub Repo")

3\. Go into your new repository, click the green **Clone** button, and copy the URL to your clipboard.

![Clone GitHub Repo](github-clone-repository.png "Clone GitHub Repo")
